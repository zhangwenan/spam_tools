...
public class MailServiceImpl  implements MailService{
    ...
    @Override
    public  int updateMailSendFromByAddress(MailSendFromDO mailSendFromDO) throws Exception{
    ...
    @Override
     public int delMailSendFromByAddress(int id) throws  Exception{
        return sqlSession.update("MailSendFromMapper.delMailSendFromByAddress",id);
     }
}
